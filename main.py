...
def defence(ch_name, ch_class):
    if ch_class == 'warrior':
        return (f'{ch_name} блокировал {10 + randint(5, 10)} урона')
    if ch_class == 'mage':
        return (f'{ch_name} блокировал {10 + randint(-2, 2)} урона')
    if ch_class == 'healer':
        return (f'{ch_name} блокировал {10 + randint(2, 5)} урона')
